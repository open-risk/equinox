...
# python3 $DJANGO_DIR/manage.py extract_covid_policy_dataflows
...
# python3 $DJANGO_DIR/manage.py create_covid_policy_dataflow_dir
echo "-> Step 3: Successful"

echo "-> Step 4: Extracting Dataseries"
# python3 $DJANGO_DIR/manage.py extract_covid_policy_dataseries
echo "-> Step 4: Successful"

echo "-> Step 5: Create Dimensions Dictionary"
# python3 $DJANGO_DIR/manage.py create_covid_policy_dimension_dict
echo "-> Step 5: Successful"

echo "-> Step 6: Process Policy Data"
python3 $DJANGO_DIR/manage.py process_covid_policy
echo "-> Step 6: Successful"

echo "-> Step 7: Create Dataflow Catalog"
# python3 $DJANGO_DIR/manage.py create_policy_dataflow_catalog
